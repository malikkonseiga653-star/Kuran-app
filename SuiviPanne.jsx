...
export default function SuiviPanne() {
  ...
  const rechercher = async () => {
    ...
    setChargement(true);
    try {
      // On cherche d'abord dans "pannes", puis dans "installations" si rien trouvé.
  ...
  // Rafraîchissement en direct : quand l'admin répond, le client voit le message sans recharger.
  useEffect(() => {
    if (!resultat) return;
