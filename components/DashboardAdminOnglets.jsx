...
import { Phone, GraduationCap, Shield, Star } from "lucide-react";
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {liste.map((e) => (
          <div key={e.id} style={{ background: "white", borderRadius: 14, padding: 16, border: "1px solid #eee" }}>
            ...
            {estAdminPrincipal && (
              <div style={{ marginTop: 12, paddingTop: 12, borderTop: "1px solid #f0f0f0", display: "flex", flexDirection: "column", gap: 6, font
